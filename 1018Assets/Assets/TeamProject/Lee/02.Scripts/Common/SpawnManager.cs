...
public class SpawnManager : MonoBehaviour
{
    ...
    private AudioClip BookHeadIdle;
    ...
    private void Awake()
    {
        ...
        BookHeadIdle = Resources.Load<AudioClip>("Sound/BookHead/B_Idle");
    ...
    IEnumerator RespawnWait(float Delay, List<Transform> SpawnPoint, GameObject RespawnObj, Transform Standard)
    {
        ...
        InGameSoundManager.instance.ActiveSound(RespawnObj, BookHeadIdle, 6.0f, true, true, true, 1);
    }
