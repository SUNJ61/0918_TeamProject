...
public class PlayerHealth : CretureUpdate
{
    ...
    private void Awake()
    {
        ...
        DeadImage = GameObject.Find("PlayCanves").transform.GetChild(0).GetComponent<Image>();
        Damage_Image = GameObject.Find("PlayCanves").transform.GetChild(1).GetComponent<Image>();
    }
